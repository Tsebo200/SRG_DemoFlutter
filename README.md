...
Unauthorised use of this software or any derivative work based on its concept or functionality
is strictly prohibited and may result in legal action under applicable intellectual property laws.

This repository is provided solely for viewing and demonstration purposes. Access to the code
does not grant any rights, license, or permission to use, modify, or distribute any part of it.

All product names, logos, and trademarks referenced in this project are the property of their respective owners.
